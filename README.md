...
<h3>▶  테스트용 아이디&비밀번호는 🔹포트폴리오 15p🔹 에 있습니다!</h3>
...
# 🚩 그룹웨어 서비스
![main](https://github.com/user-attachments/assets/83d57ae0-3342-459d-ac96-7b36adf934dc)


# 서비스 소개
> - 해당 프로젝트는 사용자의 업무효율 상승과 협업을 위해 제작된 서비스
> - 주요 기능은 인사/근태관리, 프로젝트 협업, 전자결재, 사내메일 등으로 이루어짐

<br>

> ### 개발기간 및 인원
> 2024-07-17 ~ 2024-08-05 <br>
> 참여인원(5명)
...
# 데이터베이스 구조
![다이어그램](https://github.com/user-attachments/assets/b115b1ba-8e07-43dc-9611-7a91188e8af6)
...
> * ### 아이디는 사번으로 지정, 숫자만 입력할 수 있게 설정
> * ### Spring Intercepter 기반 접속 정보 인증
> * ### Cookie를 활용한 아이디 저장 기능
<br>


| ![image](https://github.com/user-attachments/assets/445a486c-d07d-4efa-b3bf-2a25bbaa5c81) |
|:--:|
| <h3>로그인 페이지</h3> |
...
> * ### 등록된 이메일로 인증번호를 전송, 일치할 경우 비밀번호 재설정 진행
<br>
<br>


|![비밀번호재설정1](https://github.com/user-attachments/assets/326cf8f2-f766-4b2d-9f8a-5ef4091ff332)| ![비밀번호재설정2](https://github.com/user-attachments/assets/3a5fb271-3392-4b4b-8432-c1e5633a46d7)|
|:--:|:--:|
|<h3>아이디 존재유무 체크</h3>|<h3>이메일 인증번호 발송, 검사</h3>|

<br>
<br>

|![비밀번호재설정3](https://github.com/user-attachments/assets/f4866002-1162-440b-9229-07ca4c4bee96)|
|:--:|
|<h3>인증번호 일치 시 새로운 비밀번호 설정</h3>|
...
> * ### 프로필 이미지 등록 및 일부 정보 수정 가능
> * ### Map API를 사용하여 사용자 편의성 제공

<br>

![내정보](https://github.com/user-attachments/assets/2959d822-7e59-473a-b3ff-a11ba8232e66)
...
> * ### Full Calendar를 활용한 사용자 일정관리
> * ### Database 연동으로 일정 추가, 수정, 삭제 기능
...
|![image](https://github.com/user-attachments/assets/d46f5243-8ef3-4a89-9e19-f6a005286af9)|
|:--:|
|<h3>개인 / 업무 / 제출 용도에 따라 구분하여 관리</h3>|
...
> * ### 사용자의 로그인, 로그아웃 기록 조회
> * ### 일자, 월별, 상태별로 조건부 조회 가능
> * ### Spring-AOP를 활용하여 로그인 시도 상태 로그 저장
...
# 6️⃣ 즐겨찾기
> * ### 회사 내 사원 즐겨찾기 기능이 있는 페이지
> * ### 일자, 월별, 상태별로 조건부 조회 가능
> * ### Spring-AOP를 활용하여 로그인 시도 상태 로그 저장

<br>

![image](https://github.com/user-attachments/assets/079fad30-9868-4d53-bc61-e0814fa010a7)
...
# ✅ 사내 연락처 (카테고리 탭 – 부서별 근태, 사원 검색 – 사원 정보 검색)
